...
int main(int argc, char *argv[]){
    ...
    Entidade plantinha1 = (Entity){ v2d(100,100)};
    plantinha.type = PLANTAS;
    atributos_plantas ap = (atributos_plantas){...};
    plantinha.atributos = &ap;
